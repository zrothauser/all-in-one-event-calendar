	...
	<div class="wrap">
		...
		if( ! is_multisite() && current_user_can( 'install_themes' ) ) : ?>
			<h2 class="nav-tab-wrapper">
				<a href="<?php echo $this->_registry->get( 'template.link.helper' )->admin_url( AI1EC_THEME_SELECTION_BASE_URL ) ?>" class="nav-tab nav-tab-active">
					<?php echo esc_html( __( 'Manage Themes' ) ); ?>
				</a>
				<a href="<?php echo $this->_registry->get( 'template.link.helper' )->admin_url( AI1EC_THEME_SELECTION_BASE_URL . '-install' ) ?>" class="nav-tab">
